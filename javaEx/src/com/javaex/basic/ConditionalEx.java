...
//		randomEx();
	...
	public static void breakEx() {
		// 1부터 루프를 돌려서 6과 14로 모두 나누어 덜어지는 수는 얼마?
		// 어디까지 루프를 돌려야할지 예측이 쉽지 않으니 while문(무한루프)
		int num = 1;
		while(true) {
			if(num%6==0 && num%14==0) {
				break;
	...
	public static void forEx() {
		// 문법 내에 제어변수 초기화, 반복조건, 증감식을 모두 포함
		// 1. 반복 횟수가 정해져 있을 때
	...
	public static void whileEx3() {
		...
		// 무한루프에 빠지지 않도록 해야한다
		// 그러나 경우에 따라서는 의도적으로 무한루프를 사용하기도 함
