...
public class HashtableEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("MAP:" + map);  	// 	순서는 중요 (X)
		
		//	데이터 가져오기 : get
		System.out.println("303강의실의 강의:" + map.get("303"));

		// 데이터의 변경 : put (이미 있는 키면 데이터 덮어쓰기)
		map.put("202", new Classroom("C#", "R202"));
		...
		// 값의 검색
		System.out.println("Java: " + map.containsValue("Java")); // 타입이 안맞아서 false임
		System.out.println("Java 강의 포함? " + map.containsValue(new Classroom("Java")));
		//	hashCode, equals가 적절히 오버라이드되어있어야 정상 작동한다
